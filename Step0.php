...
$command0 = 'grep ATOM '   . "$input" .  ' > ' . "$output1" . " 1>&1";
#echo $command0;
#echo getcwd() . "\n";
$myResults0 = shell_exec($command0);
#echo "Submited First Job";                      
chdir('UserData');
#echo getcwd() . "\n";
$command1 = 'sudo /usr/bin/perl /home/nandekpl/Desktop/MemProtMDWorkshop/MemProtMD/AT2CG/at2cg.pl temp.pdb 1 popc';

#echo $command1;

$myResults1 = shell_exec($command1);
#echo $myResults1;
...
?>
<html>
<a href="./UserData/MD/md.tpr">Download your TPR File</a> 
</html>
